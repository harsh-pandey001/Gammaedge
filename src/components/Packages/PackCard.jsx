...
const PackCard = () => {
  return (
    ...
    <div class="containerFostrap">
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="imgCard" href="http://www.fostrap.com/2016/03/bootstrap-3-carousel-fade-effect.html">
                    ...
                    {/* <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="imgCard" href="http://www.fostrap.com/2016/03/5-button-hover-animation-effects-css3.html">
